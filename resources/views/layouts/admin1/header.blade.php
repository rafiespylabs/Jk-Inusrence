<div class="main-header">
    ...
    <nav class="navbar navbar-header navbar-header-transparent navbar-expand-lg border-bottom" data-background-color="agean">
    <div class="container-fluid">
        ...
        <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
            <li class="nav-item">
                <a class="nav-link" href="{{route('policyholders')}}">
                    <i class="fa fa-car"></i>&nbsp;Motor
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{route('healthpolicies')}}">
                    <i class="fas fa-ambulance"></i>&nbsp;Health
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{route('otherpolicies')}}">
                    <i class="fa fa-bars"></i>&nbsp;Other
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{route('creditcard_pay')}}">
                    <i class="fa fa-credit-card"></i>&nbsp;Credit Card Pay
                </a>
            </li>
