...
use Response;
use Redirect;
class VehiclepolicyRenewController extends Controller
{
    public function index($policy_id)
    {
        $vehiclepolicy_holder=Tbl_policyholders::find($policy_id);
       ...
       return view('admin.vehiclepolicy_renew',['payment_modes'=>$payment_modes,
       'vehiclepolicy_holder'=>$vehiclepolicy_holder,'vehiclemodels'=>$vehiclemodels,
       'companies'=>$companies,'policy_categories'=>$policy_categories,'policy_id'=>$policy_id]);
    }
    public function list(Request $request)
    {
        $policy_id=$request->policy_id;
        $renews=Tbl_vehiclepolicy_renews::with('added_user','payment_mode','policy')
    ...
    public function show(Request $request)
    {
       ...
       $renew=Tbl_vehiclepolicy_renews::find($renew_id);
