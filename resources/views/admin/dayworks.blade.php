        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex align-items-center">
                    <h4 class="card-title">Day Works</h4>
            ...
            <div class="table-responsive">
                <table id="dayworks-datatable" class="table table-striped table-bordered">
                    <thead>
                        <tr>
                            <th>Sl No</th>
                            <th>Date</th>
    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="create_dayworks_form" class="form" enctype="multipart/form-data">
                @csrf
                <div class="row form-group">
                    <div class="col-4">
                        <label>Date</label>
                        <input type="date" name="date" min="" max="{{date('Y-m-d')}}" class="form-control" required>
                    </div>
                    <div class="col-4">
                        <label>Name</label>
...
$(document).ready(function() {
    ...
    var table = $('#dayworks-datatable').DataTable({
        processing: true,
        serverSide: true,
        pageLength: 10, 
        lengthMenu: [10, 25, 50, 100], 
        ajax: {
            url: "{{ route('daywork.list') }}",
            type: "GET"
        },
        columns: [
            ...
            {data: "add_more_items" ,name: "add_more_items"},
    ...
    $('#create_dayworks_form').submit(function(event) 
    {
        event.preventDefault();
        var formData = new FormData($(this)[0]); 
        $.ajax({
            url: "{{route('daywork.store')}}",
            method: "POST",
            data: formData,
            contentType: false, 
            processData: false,
