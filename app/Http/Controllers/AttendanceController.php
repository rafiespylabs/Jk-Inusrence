...
class AttendanceController extends Controller
{
    ...
    public function list()
    {
        ...
        foreach($attendances as $attend)
        {
            ...
            $html.='<td><img src="uploads/'.$attend->punchin_image.'" class="rounded" style="width:100px;"></td>';
            ...
            $html.='<td><img src="uploads/'.$attend->punch_out_image.'" class="rounded" style="width:100px;"></td>';
            $html.='<td>'.$date.'</td>';
            $html.='<td>'.$added_by.'</td>';
            $html.='</tr>';
            $i++;
